...
if __name__=='__main__':
    ...
    experiments = ['./data/repeatibility/hpatches/kptr']
    ...
    #         im2_w = (im2*255).astype(np.int).astype(np.uint8)
    #         cv2.imwrite('{}.jpg'.format(i), im2_w)
    #
...
#kptr
#nms:4, det_thresh:0.001
#hpatches-v: 0.655
#hpatches-i:0.664

#nms:8, det_thresh:0.001
#hpatches-v: 0.618
#hpatches-i:0.649
